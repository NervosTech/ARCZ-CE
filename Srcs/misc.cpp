...
/// engine_info() returns the full name of the current Nayeem version. This
/// will be either "Nayeem <Tag> DD-MM-YY" (where DD-MM-YY is the date when
/// the program was compiled) or "Nayeem <Version>", depending on whether
/// Version is empty.
